...
Based on the summary result, I am going to remove the negative values and Recovered variable from the data set. 
...
```
This map shows us that the United States of America has the largest total confirmed cases, followed by India and Brazil. In order to further demonstrate the corona virus cases by country, two tables are created. 
...
```
This histogram shows us that most of the countries had less than 20% of their population contracted the corona virus. These proportions were up to roughly 60% in some countries. However, this numbers are highly depending on the proportion of people who had covid test. 
...
This box plot shows us that California had the largest range and highest daily new cases in the period of Jan 1, 2022 to May 31, 2022. And all the top 10 states had a lot of outliners. Then I looked into the details of the case information in California.
...
This contingency table shows us that Los Angeles had the most daily cases greater than 5,000 in the period of Jan 1, 2022 to May 31, 2022, followed by San Diego. 
...
This bar plot shows us that Los Angeles had the most days with daily cases greater than 5,000 in the period of Jan 1, 2022 to May 31, 2022, followed by San Diego. 
...
This plot shows us that the corona virus cases surged in January,2022 in Los Angeles, CA. The new daily deaths were much samller than the new active and new confirmed cases. So, it is hard to see it in the plot. 
